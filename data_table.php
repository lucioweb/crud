...
<main>
    <div class="mx-auto pt-5" style="width: 90%;">
        ...
        if (isset($_GET['msg'])) {
            $msg = $_GET['msg'];
            echo '<div class="alert alert-success alert-dismissible alert-sm fade show" role="alert">
            ' . $msg . '
        ...
        <div class="text-center mb-4">
            <h3>LISTA DE CLIENTES (READ)</h3>
            <p class="text-muted">Data-list de Clientes Cadastrados</p>
        </div>
...
<footer class="footer mt-auto py-3 fixed-bottom bg-body-tertiary">
    ...
    <?php require "shareds/footer.php"; ?>
</footer>
